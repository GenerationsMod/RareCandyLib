package generations.gg.rarecandylib.common.cobblemon
...
import generations.gg.rarecandylib.cobblemon.instanceOrNull
import generations.gg.rarecandylib.common.client.model.CompiledModel
...
class RareCandyBone /*Remove when cobblemon doesn't have parts of code that assumes Bone will always be a ModelPart */(
    ...
    private fun renderModel(
        ...
        var instance = context.request(Pipelines.INSTANCE) ?: context.request(RenderContext.Companion.POSABLE_STATE).instanceOrNull<CobblemonInstanceProvider>()?.instance ?: return
