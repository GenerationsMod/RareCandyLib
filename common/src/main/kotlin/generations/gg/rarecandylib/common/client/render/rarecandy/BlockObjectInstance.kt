...
class BlockObjectInstance(transformationMatrix: Matrix4f, variant: String) : ObjectInstance(transformationMatrix, variant), BlockLightValueProvider, TintProvider {
