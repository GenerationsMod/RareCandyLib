...
class BlockAnimatedObjectInstance(transformationMatrix: Matrix4f, normalMatrix: Matrix3f, materialId: String) : AnimatedObjectInstance(transformationMatrix, normalMatrix,  materialId), BlockLightValueProvider, TintProvider {
